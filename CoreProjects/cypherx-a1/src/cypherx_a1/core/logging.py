...
tenant_id, agent_id, message). Correlation fields are merged from structlog contextvars,
which the trace middleware binds per request. Mirrors the xAgent ax-1 logging config.
"""
