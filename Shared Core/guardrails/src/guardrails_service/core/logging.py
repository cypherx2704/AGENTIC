...
tenant_id, agent_id, message``. The correlation fields (trace_id/span_id/request_id/
tenant_id/agent_id) are merged in from structlog's contextvars, which the trace
middleware binds per request.
"""
