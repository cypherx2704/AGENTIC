"""Run entry: ``python -m skill_registry`` (cross-platform).
...
def main() -> None:
    ...
    if sys.platform == "win32":
        ...
        # otherwise uvicorn re-selects the Proactor loop and psycopg breaks.
        config = uvicorn.Config(
            "skill_registry.main:app", host=host, port=port, log_config=None, loop="none"
        )
        ...
        uvicorn.run("skill_registry.main:app", host=host, port=port, log_config=None)
