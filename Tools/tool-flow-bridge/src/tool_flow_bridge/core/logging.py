...
Configures structlog to emit JSON to stdout with the Contract 6 envelope fields. The
correlation fields (trace_id/span_id/request_id/tenant_id/agent_id) are merged in from
structlog's contextvars, which the trace middleware binds per request.
"""
